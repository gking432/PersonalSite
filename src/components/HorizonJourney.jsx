...
const CONTENT_STOPS = [
  {
    ...
    label: 'PHILOSOPHY',
    text: ['Find the pattern first.'],
    sub: 'Before the build, there is always a behavior to understand.',
  },
  {
    at: 0.18, duration: 0.24, reveal: 'cloud',
    label: 'CAPABILITY',
    text: ['Make the idea tangible.'],
    sub: 'A prototype beats a meeting when the question is what should exist.',
  },
  {
  ...
  },
  {
    ...
    label: 'PROOF',
    text: ['Stay close until it ships.'],
    sub: 'Positioning, design, code, launch, measurement: the details compound.',
  },
  {
    at: 0.64, duration: 0.22, reveal: 'reflection',
    label: 'NEXT',
    text: ["I'm looking for the next", 'serious problem.'],
    sub: '',
  },
]
