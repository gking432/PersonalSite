...
export const assistantSiteTargets = {
  ...
  lab_complaint: { href: '/lab', selector: '[data-assistant-section="lab-complaint"]', label: 'Customer Issue Handler' },
  lab_role: { href: '/lab', selector: '[data-assistant-section="lab-role"]', label: 'Role Match Brief' },
  lab_reputation: { href: '/lab', selector: '[data-assistant-section="lab-reputation"]', label: 'Automated Reputation Report' },
