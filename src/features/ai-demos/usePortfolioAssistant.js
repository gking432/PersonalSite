...
export const assistantSiteTargets = {
  ...
  lab_opportunity: { href: '/lab', selector: '[data-assistant-section="lab-opportunity"]', label: 'AI Opportunity Mapper' },
  lab_role: { href: '/lab', selector: '[data-assistant-section="lab-role"]', label: 'Role Match Brief' },
  lab_reputation: { href: '/lab', selector: '[data-assistant-section="lab-reputation"]', label: 'Reputation Intelligence' },
